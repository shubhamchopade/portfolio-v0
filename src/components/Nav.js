...
export const Nav = () => {
  return (
    <NavWrapper>
      ...
      <Links>
        <StyledLink href="https://drive.google.com/file/d/1f_G3VUDKQdKckTLW4oK0wc9Q9Z8NNmqD/view?usp=sharing" target="_blank"><span>Resume</span> <svg width="56" height="51" viewBox="0 0 56 51" fill="none" xmlns="http://www.w3.org/2000/svg">
